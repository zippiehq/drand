...
func (*PublicRandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a75f7af559b51cd7, []int{0}
}
...
func (*PublicRandResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a75f7af559b51cd7, []int{1}
}
...
func (*PrivateRandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a75f7af559b51cd7, []int{2}
}
...
func (*PrivateRandResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a75f7af559b51cd7, []int{3}
}
...
func (*ECIESObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_a75f7af559b51cd7, []int{4}
}
...
func (m *ECIESObject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ECIESObject.Merge(m, src)
}
...
func init() { proto.RegisterFile("drand/public.proto", fileDescriptor_a75f7af559b51cd7) }

var fileDescriptor_a75f7af559b51cd7 = []byte{
...
// UnimplementedRandomnessServer can be embedded to have forward compatible implementations.
type UnimplementedRandomnessServer struct {
}

func (*UnimplementedRandomnessServer) Public(ctx context.Context, req *PublicRandRequest) (*PublicRandResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Public not implemented")
}
func (*UnimplementedRandomnessServer) Private(ctx context.Context, req *PrivateRandRequest) (*PrivateRandResponse, error) {
