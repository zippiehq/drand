...
func (*BeaconRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_67e68201ef81b395, []int{0}
}
...
func (*BeaconResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_67e68201ef81b395, []int{1}
}
...
func init() { proto.RegisterFile("drand/beacon.proto", fileDescriptor_67e68201ef81b395) }

var fileDescriptor_67e68201ef81b395 = []byte{
...
func (*UnimplementedBeaconServer) NewBeacon(ctx context.Context, req *BeaconRequest) (*BeaconResponse, error) {
